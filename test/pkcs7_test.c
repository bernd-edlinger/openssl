...
static int pkcs7_stream_signed_no_content_test(void)
{
    int ret = 0;
    PKCS7 *p7 = NULL;
    BIO *sink = NULL;
    ...
    const unsigned char data_signed_no_body[] = { 0x30, 0x0b, 0x06, 0x09,
        0x2a, 0x86, 0x48, 0x86, 0xf7, 0x0d, 0x01, 0x07, 0x02 };
    const unsigned char *ptr_signed_no_body = data_signed_no_body;

    ret = TEST_ptr(p7 = d2i_PKCS7(NULL, &ptr_signed_no_body,
                       sizeof(data_signed_no_body)))
...
#endif /* OPENSSL_NO_EC */
    ADD_TEST(pkcs7_stream_signed_no_content_test);

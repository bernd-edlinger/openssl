...
static const ERR_STRING_DATA SSL_str_functs[] = {
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_CTOS_RECORDSIZELIMIT, 0),
     "tls_construct_ctos_recordsizelimit"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_CONSTRUCT_STOC_RECORDSIZELIMIT, 0),
     "tls_construct_stoc_recordsizelimit"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_CTOS_RECORDSIZELIMIT, 0),
     "tls_parse_ctos_recordsizelimit"},
    ...
    {ERR_PACK(ERR_LIB_SSL, SSL_F_TLS_PARSE_STOC_RECORDSIZELIMIT, 0),
     "tls_parse_stoc_recordsizelimit"},
